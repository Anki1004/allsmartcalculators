    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 p-3 sm:p-4 md:p-6">
      <div className="max-w-4xl mx-auto bg-surface-container border border-white/10 rounded-2xl p-4 md:p-5 flex flex-col md:flex-row items-start md:items-center gap-3 sm:gap-4 shadow-2xl backdrop-blur-xl">
        ...
        <div className="flex items-center gap-2 shrink-0 self-end md:self-auto">
          <button
            onClick={decline}
            className="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-on-surface-variant hover:text-on-surface transition-colors rounded-xl hover:bg-white/5"
          >
            Decline
          </button>
          <button
            onClick={accept}
            className="px-4 sm:px-5 py-2 text-xs sm:text-sm font-semibold rounded-xl bg-gradient-to-br from-primary-dim to-primary text-white shadow-glow-primary press"
          >
            Accept
          </button>
        </div>
