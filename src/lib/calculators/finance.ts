...
export const financeCalculators: CalculatorConfig[] = [
  {
    ...
    faqs: [
      { q: 'Are these live rates?', a: 'These are reference rates updated periodically. For real-time rates, use a live forex service.' },
      { q: 'Which currencies are supported?', a: '30 major world currencies covering the Americas, Europe, Asia, Middle East, and Africa.' },
    ],
  },
  {
    slug: 'emi-calculator',
    ...
    faqs: [
      { q: 'What is EMI?', a: 'EMI stands for Equated Monthly Installment, a fixed payment made to the lender each month.' },
      { q: 'How is EMI calculated?', a: 'EMI depends on loan amount, interest rate, and tenure using the standard amortization formula.' },
    ],
  },
  {
    slug: 'sip-calculator',
  ...
  },
  {
    ...
    calculate: (i) => {
      ...
      const corpus = futureExpense * 25; // 4% withdrawal rule
