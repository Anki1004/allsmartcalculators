...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/corrections`,          lastModified: now, changeFrequency: 'monthly', priority: 0.3 },
    { url: `${BASE_URL}/accessibility-statement`, lastModified: now, changeFrequency: 'yearly', priority: 0.3 },
