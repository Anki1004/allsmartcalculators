...
export const metadata: Metadata = {
  ...
  description: 'The rules of using CalcVerse. Straightforward, fair, and written like a normal human wrote them.',
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <p className="text-lg text-on-surface-variant leading-relaxed max-w-2xl">
            These aren't written to protect us from you. They're written to be honest about what CalcVerse is — and what it isn't. Plain language, no gotchas.
          </p>
        ...
        <div className="flex flex-col gap-5">
          ...
          <GlassCard className="p-6 md:p-8">
            <h2 className="font-headline font-bold text-lg text-on-surface mb-4">What CalcVerse is</h2>
            <div className="flex flex-col gap-4">
              <div>
                <p className="text-sm font-semibold text-on-surface mb-1">A free, browser-based tool.</p>
                <p className="text-sm text-on-surface-variant leading-relaxed">CalcVerse is a collection of calculators covering finance, health, math, crypto, engineering, and everyday life. There's no subscription, no account required, and no paywall. You open it, use it, and leave — or explore. Either way, you're welcome here.</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-on-surface mb-1">Not a financial or professional service.</p>
                <p className="text-sm text-on-surface-variant leading-relaxed">CalcVerse is an educational and reference tool. It is not a bank, an investment platform, a medical service, or a licensed advisory service of any kind. The numbers it produces are a starting point for thinking, not a substitute for professional judgment.</p>
              </div>
              <div>
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">Use CalcVerse freely for personal, academic, or professional purposes. Share links to specific calculators. Reference our outputs in your own notes, reports, or documents. We're glad the tools are useful.</p>
              </div>
              <div>
                ...
                <ul className="space-y-2 mt-2">
                  {[
                    ...
                    'Use CalcVerse for anything illegal under applicable law',
              ...
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">You may link to CalcVerse calculators from your own site, blog, or app. If you want to embed a calculator directly or partner in some other way, get in touch — we're open to conversations about that.</p>
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">Every number CalcVerse produces is a mathematical result based on the inputs you provide and the assumptions embedded in each formula. The EMI calculator gives you a figure, not a guarantee from your bank. The BMI calculator gives you a number, not a medical diagnosis. Real-world outcomes will differ based on factors no general-purpose calculator can anticipate.</p>
              </div>
              <div>
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed mb-4">
              CalcVerse does not provide financial, medical, legal, tax, or any other kind of professional advice. This point matters enough that it gets its own section.
            </p>
            <ul className="space-y-3 mb-4">
              {[
                ...
                { label: 'Health', desc: 'A conversation with a doctor is worth more than any algorithm. CalcVerse\'s health tools are awareness aids, not diagnostics.' },
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">The CalcVerse name, logo, visual design, and written content are our intellectual property. You're welcome to quote or reference us with attribution, but don't replicate our branding or content in a way that implies ownership or official affiliation.</p>
              </div>
              <div>
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed mb-3">
              We try to keep CalcVerse running reliably. But servers go down, bugs happen, and sometimes we need to take things offline to ship improvements. We don't guarantee uptime and we're not liable for losses that result from the site being unavailable.
            </p>
            <p className="text-sm text-on-surface-variant leading-relaxed">
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed mb-3">
              To the extent permitted by applicable law, CalcVerse and its operators are not liable for any damages arising from your use of — or inability to use — this site. That includes direct, indirect, incidental, or consequential damages.
            </p>
            <p className="text-sm text-on-surface-variant leading-relaxed mb-3">
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed mb-3">
              CalcVerse may contain links to external websites or reference external services (like exchange rate providers, regulatory bodies, or financial tools). We link to these because they're useful, not because we endorse everything they do.
            </p>
            <p className="text-sm text-on-surface-variant leading-relaxed">
              We're not responsible for the content, accuracy, or practices of any third-party site. When you leave CalcVerse, the other site's terms and privacy policies apply.
            </p>
          </GlassCard>
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              Continuing to use CalcVerse after we update these terms means you're okay with the changes. If you're not, you can stop using the site — no hard feelings.
            </p>
          </GlassCard>
          ...
          <GlassCard className="p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed mb-3">
              These terms are governed by applicable law in the jurisdiction where CalcVerse operates. If there's ever a dispute, we genuinely prefer to resolve it by talking first — most things can be sorted out without escalation.
            </p>
            <p className="text-sm text-on-surface-variant leading-relaxed">
              Reach us at <span className="text-primary font-mono">hello@calcverse.app</span>. We read every message and take them seriously.
            </p>
          </GlassCard>
