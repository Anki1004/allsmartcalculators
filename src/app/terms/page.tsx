    ...
    <div className="pt-24 sm:pt-28 pb-12 sm:pb-20 px-4 sm:px-5 md:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        {cms?.body ? (
          ...
          {/* What AllSmartCalculators is */}
          <GlassCard className="p-5 sm:p-6 md:p-8">
            <h2 className="font-headline font-bold text-lg text-on-surface mb-4">What AllSmartCalculators is</h2>
            <div className="flex flex-col gap-4">
              <div>
                <p className="text-sm font-semibold text-on-surface mb-1">A free, browser-based tool.</p>
                <p className="text-sm text-on-surface-variant leading-relaxed">AllSmartCalculators is a collection of calculators covering finance, health, math, crypto, engineering, and everyday life. There's no subscription, no account required, and no paywall. You open it, use it, and leave — or explore. Either way, you're welcome here.</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-on-surface mb-1">Not a financial or professional service.</p>
                <p className="text-sm text-on-surface-variant leading-relaxed">AllSmartCalculators is an educational and reference tool. It is not a bank, an investment platform, a medical service, or a licensed advisory service of any kind. The numbers it produces are a starting point for thinking, not a substitute for professional judgment.</p>
              </div>
              <div>
          ...
          <GlassCard className="p-5 sm:p-6 md:p-8">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">Use AllSmartCalculators freely for personal, academic, or professional purposes. Share links to specific calculators. Reference our outputs in your own notes, reports, or documents. We're glad the tools are useful.</p>
              </div>
              <div>
                ...
                <ul className="space-y-2 mt-2">
                  {[
                    ...
                    'Use AllSmartCalculators for anything illegal under applicable law',
              ...
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">You may link to AllSmartCalculators calculators from your own site, blog, or app. If you want to embed a calculator directly or partner in some other way, get in touch — we're open to conversations about that.</p>
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-5 sm:p-6 md:p-8">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">Every number AllSmartCalculators produces is a mathematical result based on the inputs you provide and the assumptions embedded in each formula. The EMI calculator gives you a figure, not a guarantee from your bank. The BMI calculator gives you a number, not a medical diagnosis. Real-world outcomes will differ based on factors no general-purpose calculator can anticipate.</p>
              </div>
              <div>
          ...
          <GlassCard className="p-5 sm:p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed mb-4">
              AllSmartCalculators does not provide financial, medical, legal, tax, or any other kind of professional advice. This point matters enough that it gets its own section.
            </p>
            <ul className="space-y-3 mb-4">
              {[
                ...
                { label: 'Health', desc: 'A conversation with a doctor is worth more than any algorithm. AllSmartCalculators\'s health tools are awareness aids, not diagnostics.' },
          ...
          <GlassCard className="p-5 sm:p-6 md:p-8">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">The AllSmartCalculators name, logo, visual design, and written content are our intellectual property. You're welcome to quote or reference us with attribution, but don't replicate our branding or content in a way that implies ownership or official affiliation.</p>
              </div>
              <div>
          ...
          <GlassCard className="p-5 sm:p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed mb-3">
              We try to keep AllSmartCalculators running reliably. But servers go down, bugs happen, and sometimes we need to take things offline to ship improvements. We don't guarantee uptime and we're not liable for losses that result from the site being unavailable.
            </p>
            <p className="text-sm text-on-surface-variant leading-relaxed">
          ...
          <GlassCard className="p-5 sm:p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed mb-3">
              To the extent permitted by applicable law, AllSmartCalculators and its operators are not liable for any damages arising from your use of — or inability to use — this site. That includes direct, indirect, incidental, or consequential damages.
            </p>
            <p className="text-sm text-on-surface-variant leading-relaxed mb-3">
          ...
          <GlassCard className="p-5 sm:p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed mb-3">
              AllSmartCalculators may contain links to external websites or reference external services (like exchange rate providers, regulatory bodies, or financial tools). We link to these because they're useful, not because we endorse everything they do.
            </p>
            <p className="text-sm text-on-surface-variant leading-relaxed">
              We're not responsible for the content, accuracy, or practices of any third-party site. When you leave AllSmartCalculators, the other site's terms and privacy policies apply.
            </p>
          </GlassCard>
          ...
          <GlassCard className="p-5 sm:p-6 md:p-8">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              Continuing to use AllSmartCalculators after we update these terms means you're okay with the changes. If you're not, you can stop using the site — no hard feelings.
            </p>
          </GlassCard>
